...
export function PagareSection({ doc }: PagareSectionProps) {
  ...
  return (
    <div className="mt-1.5 border-2 border-black p-1.5 text-[9px] font-semibold leading-tight text-black">
      ...
      <div className="mt-1.5 grid grid-cols-2 gap-1.5">
        <div className="border border-black">
          ...
          <div className="space-y-0 p-1 text-[8.5px] leading-tight">
            <p>
        ...
        <div className="flex flex-col justify-end border border-black p-1.5">
          ...
          <div className="mt-4 border-t border-black pt-0.5">
